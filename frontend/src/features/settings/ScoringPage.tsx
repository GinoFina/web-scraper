...
const AVAILABLE_METRICS = [
  ...
  "expected_assists", "rating", "total_passes", "accurate_passes", "accurate_passes_pct",
  "key_passes", "big_chances_created", "total_long_balls", "accurate_long_balls",
  "accurate_long_balls_pct", "total_crosses", "accurate_crosses", "accurate_crosses_pct",
  "total_shots", "shots_on_target", "shots_off_target", "big_chances_missed",
  "dribbles_attempted", "dribbles_won", "dribbles_won_pct", "aerial_duels_total", "aerial_duels_won", "aerial_duels_won_pct",
  "ground_duels_total", "ground_duels_won", "ground_duels_won_pct", "tackles", "interceptions",
  "clearances", "blocked_shots", "dispossessed", "offsides", "possession_lost",
  "total_duels_total", "total_duels_won", "total_duels_won_pct", "saves", "clean_sheets",
